    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case PopularWishesRow:
            return PopularWishesRow(data);
