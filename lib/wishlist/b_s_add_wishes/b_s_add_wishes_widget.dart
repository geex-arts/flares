...
class BSAddWishesWidget extends StatefulWidget {
  const BSAddWishesWidget({super.key});

  @override
  State<BSAddWishesWidget> createState() => _BSAddWishesWidgetState();
}

class _BSAddWishesWidgetState extends State<BSAddWishesWidget> {
  late BSAddWishesModel _model;
